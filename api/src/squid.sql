...
-- Table `squid`.`Rating`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `squid`.`Rating` (
...
-- -----------------------------------------------------
-- Data for table `squid`.`Rating`
-- -----------------------------------------------------
START TRANSACTION;
USE `squid`;
INSERT INTO `squid`.`Rating` (`contributionsId`, `usersId`, `rating`, `createdAt`, `updatedAt`) VALUES (1, 1, +1, DEFAULT, NULL);
INSERT INTO `squid`.`Rating` (`contributionsId`, `usersId`, `rating`, `createdAt`, `updatedAt`) VALUES (1, 2, -1, DEFAULT, NULL);
INSERT INTO `squid`.`Rating` (`contributionsId`, `usersId`, `rating`, `createdAt`, `updatedAt`) VALUES (1, 3, +1, DEFAULT, NULL);
INSERT INTO `squid`.`Rating` (`contributionsId`, `usersId`, `rating`, `createdAt`, `updatedAt`) VALUES (2, 3, +1, DEFAULT, NULL);
